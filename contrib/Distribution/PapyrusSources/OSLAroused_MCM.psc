...
event OnOptionSelect(int optionId)
    ...
    ElseIf(CurrentPage == "$OSL_Help")
        if(optionId == HelpArousalModeOid)
            ShowMessage("$OSL_HelpArousalMode", false)
        elseif(optionId == HelpOverviewOid)
            ShowMessage("$OSL_HelpOverview", false)
        elseif(optionId == HelpCurrentArousalOid)
            ShowMessage("$OSL_HelpArousal", false)
        elseif(optionId == HelpBaselineArousalOid)
            ShowMessage("$OSL_HelpBaseline", false)
        elseif(optionId == HelpLibidoOid)
            ShowMessage("$OSL_HelpLibido", false)
        elseif(optionId == HelpGainArousalOid)
            ShowMessage("$OSL_HelpGainArousal", false)
        elseif(optionId == HelpLowerArousalOid)
            ShowMessage("$OSL_HelpLowerArousal", false)
        elseif(optionId == HelpGainBaselineOid)
            ShowMessage("$OSL_HelpRaiseBaseline", false)
        elseif(optionId == HelpLowerBaselineOid)
            ShowMessage("$OSL_HelpLowerBaseline", false)
        endif
    EndIf
endevent
