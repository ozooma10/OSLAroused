...
{
    SKSE::log::trace("ArosualManager::Setting Arousal System to {} bResetData: {}", (int)newMode, bResetData);
...
ArousalManager::ArousalManager()
{
	...
	SKSE::log::trace("ArousalManager::ArousalManager Initializing with {}", (int)arousalMode);
