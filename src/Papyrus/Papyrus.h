...
namespace Papyrus
{
	...
	std::vector<RE::BSFixedString> GetRegisteredKeywords(RE::StaticFunctionTag* base);
	bool RegisterNewKeyword(RE::StaticFunctionTag* base, RE::BSFixedString keywordEditorId);
